...
{
    public readonly double enumPercentage = 0.20; 
    public readonly int formattedUniqueLengths = 10; 
        
    private readonly Dictionary<int, int> lengthMap = new ();
    private readonly Dictionary<String, int> enumMap = new ();
