...
public class SedReplace : ILineTransformer
{
    ...
    private bool hasReplacementFormat;
        
    public SedReplace(String pattern, String replacement, String? flags = null)
    {
    ...
    public String transformLine(String line)
    {
        ...
        while (match.Success && match.Value.Length > 0)
        {
            ...
            {
                shouldReplace = matchReplaceRanges(matchIndex, replaceRanges);
            }
    ...
    private static bool matchReplaceRanges(int matchIndex, List<IndexRange> replaceRanges)
    {
        foreach (IndexRange toCheck in replaceRanges)
