...
public class PnyxHeaderNameTest
{
    ...
    public async Task headerNames(int headers, String expected, params Object[] columnNumbersAndNames)
    {
    ...
    public async Task headerNamesError(String message, params Object[] columnNumbersAndNames)
    {
        await using Pnyx p = new Pnyx();
        p.readString("bb");
        p.parseCsv(hasHeader: true);
